    ...
    <section className={`${className}`}>
      ...
      <AppIntroText>
        ...
        <p>
          ...
          bánh Âu được hình thành từ năm 2013 dưới tên Tina Cafeteria, kinh
          doanh online từ năm 2011. Tina Cake nguyên thủy là một tiệm Cafe Bánh
          chuyên các loại bánh Âu, bánh Cupcakes, các món tráng miệng được phục
          vụ theo mô hình Dessert Plate. Đội ngũ chúng tôi xuất thân từ những
          đầu bếp khách sạn, mong muốn đem các món ăn hương vị Âu về với giới
          trẻ thành phố Nha Trang một cách gần gũi nhất.
        </p>
      </AppIntroText>
      ...
      <AppIntroText>
        ...
        <img src="https://images.unsplash.com/photo-1532444482250-cb75e6bbd1fb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" />
      </AppIntroText>
    </section>
  );
};
